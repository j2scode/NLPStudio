...
#' Curator
#'
#' \code{Curator} This class is responsible for (re)building objects and
...
#'
#'
#' The Curator class is a participant of the State family of classes.
#'
...
#'  save/restore method within the Curator class to serialize or
#'  deserialize the object.
#'  \item Curator: This class is responsible for (re)building objects from prior states.
#'  }
#'
#' \strong{Curator Collaborators:}
#'  \itemize{
#'   \item Lab: The class containing document collections.
#'   \item DocumentCollections: The composite member of the Document0 Composition set of classes.  Contains documents and other collections. Curator invokes restore processes through various accept methods in this class.
#'   \item Document: The leaf member of the Document0 Composition set of classes. Curator invokes restore processes through various accept methods in this class.
  ...
  private = list(
    ...
    update = function() {
      ...
      lapply(private$..comparison$restore, function(u) {
        ...
        vUpdate <- VCurator$new()
        currentObject$acceptVCurator(vUpdate, priorObject)
      })
    },
